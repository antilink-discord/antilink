...
AntiLink - це публічний бот з відкритим вихідним кодом для захисту гільдій від небажаних користувачів. Запросити бота можна на [сайті](https://antilink.pp.ua/).
